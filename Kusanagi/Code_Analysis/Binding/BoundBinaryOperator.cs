...
namespace Kusanagi.Code_Analysis.Binding
{
    internal sealed class BoundBinaryOperator
    {
        ...
        private static BoundBinaryOperator[] _operators =
        {
            ...
            new BoundBinaryOperator(SyntaxKind.NotEqualityToken, BoundBinaryOperatorKind.NotEquals, typeof(int), typeof(bool)),
            ...
            new BoundBinaryOperator(SyntaxKind.NotEqualityToken, BoundBinaryOperatorKind.NotEquals, typeof(bool)),
